...
function Blog({ mdxSource, frontMatter }) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(head_1.default, null,
            ...
            React.createElement("meta", { property: "og:title", content: `Stiven Castillo | ${title}` }),
            ...
            React.createElement("meta", { property: "og:url", content: `${URL}/notes/${slug}` }),
...
async function getStaticPaths() {
    const posts = await (0, mdx_1.getFiles)('notes');
    return {
        paths: posts.map((p) => ({
            params: {
...
async function getStaticProps({ params }) {
    const post = await (0, mdx_1.getFileBySlug)('notes', params.slug.join('/'));
    return { props: post };
}
